...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand ms-3" href="#">Agendamentos</a>
  <button 
    ...
    <div class="row">
      <div class="col-4">
        <div class="card text-bg-info mb-3">
          ...
          <div class="card-body">
            <h5 class="card-title" id="agendamentosAtivosCount">0</h5>
          </div>
        </div>
      </div>
      <div class="col-4">
        <div class="card text-bg-success mb-3">
          ...
          <div class="card-body">
            <h5 class="card-title" id="agendamentosConcluidosCount">0</h5>
          </div>
        </div>
      </div>
      <div class="col-4">
        <div class="card text-bg-warning mb-3">
          ...
          <div class="card-body">
            <h5 class="card-title" id="usuariosCount">0</h5>
          </div>
        </div>
      </div>
    </div>
